...
const staticProducts = [
  ...
  },
  {
    ...
    imageAlt: "Front of men's Basic Tee with Artwork.",
    price: '$35',
    color: 'Iso Dots',
  },
  // More products...
...
export default function HomePage({ products }) {
  ...
  return (
    <main>
      <div className="bg-white h-full px-4 lg:px-10 flex flex-col justify-between">
        <div className="relative isolate px-6 pt-12 lg:px-6 mb-20">
          ...
          <div className="mx-auto max-w-4xl pt-32 sm:pt-48 lg:pt-56">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg leading-7 text-gray-600">
                Take your digital products to another level with our collection of UI kits, <br /> 
                templates and icon sets. All our assets were carefully designed to work together. <br />
                We have obsessed over every little detailes, and we believe it shows. 
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href="#"
                  className="rounded-md bg-gray-900 px-6 py-4 text-base font-medium text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600 divide-x divide-gray-600 "
                >
      ...
      <div className="max-w-2xl px-4 py-20 sm:px-6 sm:py-28 lg:max-w-full lg:px-8">
      ...
      <div className="flex items-center justify-center border-neutral-200 p-5 lg:justify-between">
          <div className="mr-12 hidden lg:block text-sm">
            <span>© 2023 Workflow, Inc. All Rights Reserved.</span>
          </div>
